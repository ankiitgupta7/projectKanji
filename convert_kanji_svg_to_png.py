...
# OUTPUT_FOLDER = "kanji_png256"   # Output directory for PNG files
...
#         svg_content = f'''
#         <svg xmlns="http://www.w3.org/2000/svg" width="256" height="256" viewBox="0 0 109 109">
...
#         # Convert to PNG (extract strokes only, no fill)
#         cairosvg.svg2png(url=svg_output, write_to=png_output, output_width=256, output_height=256)
